...
def totalsegmentator(input: Union[str, Path, Nifti1Image], output: Union[str, Path, None] = None, ml=False,
    ...
    #                                            trainer=crop_trainer, tta=False, multilabel_image=True,
    #                                            resample=crop_spacing,
    #                                            crop=None, crop_path=None, task_name=crop_task, nora_tag="None",
    #                                            preview=False,
    #                                            save_binary=False, nr_threads_resampling=nr_thr_resamp,
    #                                            nr_threads_saving=1,
    ...
    #                                           preview=False,
    #                                           save_binary=True, nr_threads_resampling=nr_thr_resamp,
    #                                           nr_threads_saving=1,
    #                                           crop_addon=crop_addon, output_type=output_type, statistics=False,
    #                                           quiet=quiet, verbose=verbose, test=0, skip_saving=False, device=device)
    #     crop = body_seg
